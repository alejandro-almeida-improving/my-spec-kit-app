...
Obtén las imágenes y data de la pagina; ademas ten en cuenta que cada sección usa un Carousel para mostrar las imágenes, (usa el Carousel de Shadcn).
```

### Create a technical implementation plan

```
/speckit.plan Esta es la pagina de Netflix: https://www.netflix.com/mx-en/browse/genre/34399. Si es posible obtén las imágenes y data de la pagina.
```
